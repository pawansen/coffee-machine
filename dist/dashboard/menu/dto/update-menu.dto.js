...
exports.UpdateStatusDto = exports.UpdateMenuDto = void 0;
const mapped_types_1 = require("@nestjs/mapped-types");
const create_menu_dto_1 = require("./create-menu.dto");
const class_validator_1 = require("class-validator");
const class_transformer_1 = require("class-transformer");
class UpdateMenuDto extends (0, mapped_types_1.PartialType)(create_menu_dto_1.CreateVenueDto) {
}
...
__decorate([
    ...
    (0, class_transformer_1.Transform)(({ value }) => value?.trim()),
    __metadata("design:type", String)
], UpdateMenuDto.prototype, "discount", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
    (0, class_transformer_1.Transform)(({ value }) => value?.trim()),
    __metadata("design:type", String)
], UpdateMenuDto.prototype, "venueId", void 0);
